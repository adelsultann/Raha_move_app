...
abstract mixin class $PreferencesFormStateCopyWith<$Res>  {
  factory $PreferencesFormStateCopyWith(PreferencesFormState value, $Res Function(PreferencesFormState) _then) = _$PreferencesFormStateCopyWithImpl;
@useResult
$Res call({
...
/// Create a copy of PreferencesFormState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? experienceLevel = freezed,Object? preferredPositions = null,Object? weeklyGoalDays = null,Object? reminderInterest = null,}) {
  return _then(PreferencesFormState(
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _PreferencesFormState value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _PreferencesFormState value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _PreferencesFormState value)?  $default,){
final _that = this;
switch (_that) {
case _PreferencesFormState() when $default != null:
return $default(_that);case _:
...
class _PreferencesFormState extends PreferencesFormState {
  const _PreferencesFormState({this.experienceLevel,  Set<MovementPosition> preferredPositions = const <MovementPosition>{}, this.weeklyGoalDays = 3, this.reminderInterest = false}): _preferredPositions = preferredPositions,super._();
...
@pragma('vm:prefer-inline')
_$PreferencesFormStateCopyWith<_PreferencesFormState> get copyWith => __$PreferencesFormStateCopyWithImpl<_PreferencesFormState>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PreferencesFormState&&(identical(other.experienceLevel, experienceLevel) || other.experienceLevel == experienceLevel)&&const DeepCollectionEquality().equals(other._preferredPositions, _preferredPositions)&&(identical(other.weeklyGoalDays, weeklyGoalDays) || other.weeklyGoalDays == weeklyGoalDays)&&(identical(other.reminderInterest, reminderInterest) || other.reminderInterest == reminderInterest));
}
...
/// @nodoc
abstract mixin class _$PreferencesFormStateCopyWith<$Res> implements $PreferencesFormStateCopyWith<$Res> {
  factory _$PreferencesFormStateCopyWith(_PreferencesFormState value, $Res Function(_PreferencesFormState) _then) = __$PreferencesFormStateCopyWithImpl;
@override @useResult
$Res call({
 ExperienceLevel? experienceLevel, Set<MovementPosition> preferredPositions, int weeklyGoalDays, bool reminderInterest
});
...
/// Create a copy of PreferencesFormState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? experienceLevel = freezed,Object? preferredPositions = null,Object? weeklyGoalDays = null,Object? reminderInterest = null,}) {
