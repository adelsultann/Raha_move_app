...
mixin _$RecommendationCandidate {
  ...
  $RecommendationCandidateCopyWith<RecommendationCandidate> get copyWith =>
      _$RecommendationCandidateCopyWithImpl<RecommendationCandidate>(
        this as RecommendationCandidate,
        _$identity,
      );
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(
                  other.exercisesSafetyApproved,
                  exercisesSafetyApproved,
                ) ||
                other.exercisesSafetyApproved == exercisesSafetyApproved) &&
            (identical(
                  other.exercisesHavePlayableMedia,
                  exercisesHavePlayableMedia,
                ) ||
                other.exercisesHavePlayableMedia ==
                    exercisesHavePlayableMedia) &&
...
abstract mixin class $RecommendationCandidateCopyWith<$Res> {
  factory $RecommendationCandidateCopyWith(
    RecommendationCandidate value,
    $Res Function(RecommendationCandidate) _then,
  ) = _$RecommendationCandidateCopyWithImpl;
  @useResult
  $Res call({
    String routineId,
    ...
    bool exercisesSafetyApproved,
    bool exercisesHavePlayableMedia,
...
class _$RecommendationCandidateCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object? exercisesSafetyApproved = null,
    Object? exercisesHavePlayableMedia = null,
      ...
      RecommendationCandidate(
        ...
        exerciseIds: null == exerciseIds
            ...
            : exerciseIds // ignore: cast_nullable_to_non_nullable
                  as Set<String>,
        exercisesSafetyApproved: null == exercisesSafetyApproved
            ? _self.exercisesSafetyApproved
            : exercisesSafetyApproved // ignore: cast_nullable_to_non_nullable
                  as bool,
        exercisesHavePlayableMedia: null == exercisesHavePlayableMedia
            ? _self.exercisesHavePlayableMedia
            : exercisesHavePlayableMedia // ignore: cast_nullable_to_non_nullable
                  as bool,
        minimumAppVersion: freezed == minimumAppVersion
...
extension RecommendationCandidatePatterns on RecommendationCandidate {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_RecommendationCandidate value)? $default, {
    ...
    switch (_that) {
      case _RecommendationCandidate() when $default != null:
        return $default(
          ...
          _that.positions,
          _that.exerciseIds,
          _that.exercisesSafetyApproved,
          _that.exercisesHavePlayableMedia,
          _that.minimumAppVersion,
        );
      case _:
        return orElse();
    }
...
class _RecommendationCandidate implements RecommendationCandidate {
  const _RecommendationCandidate({
    ...
    required this.exercisesSafetyApproved,
    required this.exercisesHavePlayableMedia,
  ...
  /// True only when every referenced exercise is safety-approved.
  @override
  final bool exercisesSafetyApproved;

  /// True only when every referenced exercise has a preferred, published,
  /// playable media asset.
  @override
  final bool exercisesHavePlayableMedia;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$RecommendationCandidateCopyWith<_RecommendationCandidate> get copyWith =>
      __$RecommendationCandidateCopyWithImpl<_RecommendationCandidate>(
        this,
        _$identity,
      );
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _RecommendationCandidate &&
            (identical(other.routineId, routineId) ||
                other.routineId == routineId) &&
            (identical(other.status, status) || other.status == status) &&
            (identical(other.accessTier, accessTier) ||
...
/// @nodoc
abstract mixin class _$RecommendationCandidateCopyWith<$Res>
    implements $RecommendationCandidateCopyWith<$Res> {
  factory _$RecommendationCandidateCopyWith(
    _RecommendationCandidate value,
    $Res Function(_RecommendationCandidate) _then,
  ) = __$RecommendationCandidateCopyWithImpl;
  @override
  @useResult
  $Res call({
    String routineId,
