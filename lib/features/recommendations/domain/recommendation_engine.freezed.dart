...
mixin _$RecommendationRequest {
 ...
 CheckInAnswers get checkIn; List<RecommendationCandidate> get candidates; UserPreferences get preferences; RecommendationHistory get history; RecommendationConfig get config;/// The "now" instant for the recency window. Must be injected (not read
...
$RecommendationRequestCopyWith<RecommendationRequest> get copyWith => _$RecommendationRequestCopyWithImpl<RecommendationRequest>(this as RecommendationRequest, _$identity);
...
as List<RecommendationCandidate>,preferences: null == preferences ? _self.preferences : preferences // ignore: cast_nullable_to_non_nullable
as UserPreferences,history: null == history ? _self.history : history // ignore: cast_nullable_to_non_nullable
as RecommendationHistory,config: null == config ? _self.config : config // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _RecommendationRequest value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _RecommendationRequest value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _RecommendationRequest value)?  $default,){
final _that = this;
switch (_that) {
case _RecommendationRequest() when $default != null:
return $default(_that);case _:
...
@override List<RecommendationCandidate> get candidates {
...
@override final  RecommendationHistory history;
@override final  RecommendationConfig config;
...
@pragma('vm:prefer-inline')
_$RecommendationRequestCopyWith<_RecommendationRequest> get copyWith => __$RecommendationRequestCopyWithImpl<_RecommendationRequest>(this, _$identity);
...
/// @nodoc
abstract mixin class _$RecommendationRequestCopyWith<$Res> implements $RecommendationRequestCopyWith<$Res> {
...
mixin _$ScoredRoutine {
 ...
 String get routineId;/// Zero-based rank (0 = top candidate). Matches the local convention used
/// by `local_recommendations.rank`.
 int get rank;/// Total score, comparable only within [RecommendationResult.engineVersion].
 int get score;/// Component key → integer contribution. Deterministically ordered.
 Map<String, int> get scoreComponents;/// Stable, language-neutral reason keys, in canonical order.
 List<String> get reasonCodes;
/// Create a copy of ScoredRoutine
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$ScoredRoutineCopyWith<ScoredRoutine> get copyWith => _$ScoredRoutineCopyWithImpl<ScoredRoutine>(this as ScoredRoutine, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ScoredRoutine&&(identical(other.routineId, routineId) || other.routineId == routineId)&&(identical(other.rank, rank) || other.rank == rank)&&(identical(other.score, score) || other.score == score)&&const DeepCollectionEquality().equals(other.scoreComponents, scoreComponents)&&const DeepCollectionEquality().equals(other.reasonCodes, reasonCodes));
}


@override
int get hashCode => Object.hash(runtimeType,routineId,rank,score,const DeepCollectionEquality().hash(scoreComponents),const DeepCollectionEquality().hash(reasonCodes));
...
abstract mixin class $ScoredRoutineCopyWith<$Res>  {
  factory $ScoredRoutineCopyWith(ScoredRoutine value, $Res Function(ScoredRoutine) _then) = _$ScoredRoutineCopyWithImpl;
@useResult
$Res call({
 String routineId, int rank, int score, Map<String, int> scoreComponents, List<String> reasonCodes
});
...
/// Create a copy of ScoredRoutine
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? routineId = null,Object? rank = null,Object? score = null,Object? scoreComponents = null,Object? reasonCodes = null,}) {
  return _then(ScoredRoutine(
routineId: null == routineId ? _self.routineId : routineId // ignore: cast_nullable_to_non_nullable
as String,rank: null == rank ? _self.rank : rank // ignore: cast_nullable_to_non_nullable
as int,score: null == score ? _self.score : score // ignore: cast_nullable_to_non_nullable
as int,scoreComponents: null == scoreComponents ? _self.scoreComponents : scoreComponents // ignore: cast_nullable_to_non_nullable
as Map<String, int>,reasonCodes: null == reasonCodes ? _self.reasonCodes : reasonCodes // ignore: cast_nullable_to_non_nullable
as List<String>,
  ));
}
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ScoredRoutine value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ScoredRoutine value)  $default,){
final _that = this;
switch (_that) {
case _ScoredRoutine():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ScoredRoutine value)?  $default,){
final _that = this;
switch (_that) {
case _ScoredRoutine() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String routineId,  int rank,  int score,  Map<String, int> scoreComponents,  List<String> reasonCodes)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ScoredRoutine() when $default != null:
return $default(_that.routineId,_that.rank,_that.score,_that.scoreComponents,_that.reasonCodes);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String routineId,  int rank,  int score,  Map<String, int> scoreComponents,  List<String> reasonCodes)  $default,) {final _that = this;
switch (_that) {
case _ScoredRoutine():
return $default(_that.routineId,_that.rank,_that.score,_that.scoreComponents,_that.reasonCodes);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String routineId,  int rank,  int score,  Map<String, int> scoreComponents,  List<String> reasonCodes)?  $default,) {final _that = this;
switch (_that) {
case _ScoredRoutine() when $default != null:
return $default(_that.routineId,_that.rank,_that.score,_that.scoreComponents,_that.reasonCodes);case _:
  return null;
...
class _ScoredRoutine implements ScoredRoutine {
  const _ScoredRoutine({required this.routineId, required this.rank, required this.score, required  Map<String, int> scoreComponents, required  List<String> reasonCodes}): _scoreComponents = scoreComponents,_reasonCodes = reasonCodes;
...
/// Component key → integer contribution. Deterministically ordered.
@override Map<String, int> get scoreComponents {
...
/// Stable, language-neutral reason keys, in canonical order.
@override List<String> get reasonCodes {
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$ScoredRoutineCopyWith<_ScoredRoutine> get copyWith => __$ScoredRoutineCopyWithImpl<_ScoredRoutine>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ScoredRoutine&&(identical(other.routineId, routineId) || other.routineId == routineId)&&(identical(other.rank, rank) || other.rank == rank)&&(identical(other.score, score) || other.score == score)&&const DeepCollectionEquality().equals(other._scoreComponents, _scoreComponents)&&const DeepCollectionEquality().equals(other._reasonCodes, _reasonCodes));
}


@override
int get hashCode => Object.hash(runtimeType,routineId,rank,score,const DeepCollectionEquality().hash(_scoreComponents),const DeepCollectionEquality().hash(_reasonCodes));
...
/// @nodoc
abstract mixin class _$ScoredRoutineCopyWith<$Res> implements $ScoredRoutineCopyWith<$Res> {
  factory _$ScoredRoutineCopyWith(_ScoredRoutine value, $Res Function(_ScoredRoutine) _then) = __$ScoredRoutineCopyWithImpl;
@override @useResult
$Res call({
 String routineId, int rank, int score, Map<String, int> scoreComponents, List<String> reasonCodes
});
...
/// Create a copy of ScoredRoutine
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? routineId = null,Object? rank = null,Object? score = null,Object? scoreComponents = null,Object? reasonCodes = null,}) {
  return _then(_ScoredRoutine(
routineId: null == routineId ? _self.routineId : routineId // ignore: cast_nullable_to_non_nullable
as String,rank: null == rank ? _self.rank : rank // ignore: cast_nullable_to_non_nullable
as int,score: null == score ? _self.score : score // ignore: cast_nullable_to_non_nullable
as int,scoreComponents: null == scoreComponents ? _self._scoreComponents : scoreComponents // ignore: cast_nullable_to_non_nullable
as Map<String, int>,reasonCodes: null == reasonCodes ? _self._reasonCodes : reasonCodes // ignore: cast_nullable_to_non_nullable
as List<String>,
  ));
}
...
mixin _$RecommendationResult {
 ...
 String get engineVersion; List<ScoredRoutine> get recommendations;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RecommendationResult&&(identical(other.engineVersion, engineVersion) || other.engineVersion == engineVersion)&&const DeepCollectionEquality().equals(other.recommendations, recommendations));
}


@override
int get hashCode => Object.hash(runtimeType,engineVersion,const DeepCollectionEquality().hash(recommendations));
...
@useResult
$Res call({
 String engineVersion, List<ScoredRoutine> recommendations
});
...
/// Create a copy of RecommendationResult
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? engineVersion = null,Object? recommendations = null,}) {
  return _then(RecommendationResult(
engineVersion: null == engineVersion ? _self.engineVersion : engineVersion // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String engineVersion,  List<ScoredRoutine> recommendations)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RecommendationResult() when $default != null:
return $default(_that.engineVersion,_that.recommendations);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String engineVersion,  List<ScoredRoutine> recommendations)  $default,) {final _that = this;
switch (_that) {
case _RecommendationResult():
return $default(_that.engineVersion,_that.recommendations);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String engineVersion,  List<ScoredRoutine> recommendations)?  $default,) {final _that = this;
switch (_that) {
case _RecommendationResult() when $default != null:
return $default(_that.engineVersion,_that.recommendations);case _:
  return null;
...
class _RecommendationResult extends RecommendationResult {
  const _RecommendationResult({required this.engineVersion, required  List<ScoredRoutine> recommendations}): _recommendations = recommendations,super._();
  

@override final  String engineVersion;
 final  List<ScoredRoutine> _recommendations;
@override List<ScoredRoutine> get recommendations {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _RecommendationResult&&(identical(other.engineVersion, engineVersion) || other.engineVersion == engineVersion)&&const DeepCollectionEquality().equals(other._recommendations, _recommendations));
}


@override
int get hashCode => Object.hash(runtimeType,engineVersion,const DeepCollectionEquality().hash(_recommendations));
...
/// Create a copy of RecommendationResult
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? engineVersion = null,Object? recommendations = null,}) {
