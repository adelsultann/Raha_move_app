...
mixin _$Exercise {
  ...
  SafetyReviewStatus get safetyReviewStatus;
  Map<String, LocalizedExerciseContent> get translations;
  ExerciseClassification get classification;
  List<ProviderExerciseMapping> get providerMappings;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.safetyReviewStatus, safetyReviewStatus) ||
                other.safetyReviewStatus == safetyReviewStatus) &&
  ...
  int get hashCode => Object.hash(
    ...
    classification,
    const DeepCollectionEquality().hash(providerMappings),
    const DeepCollectionEquality().hash(mediaAssets),
  );
...
abstract mixin class $ExerciseCopyWith<$Res> {
  ...
  $Res call({
    ...
    Map<String, LocalizedExerciseContent> translations,
...
class _$ExerciseCopyWithImpl<$Res> implements $ExerciseCopyWith<$Res> {
  ...
  $Res call({
    ...
    Object? safetyReviewStatus = null,
    Object? translations = null,
    Object? classification = null,
    Object? providerMappings = null,
    Object? mediaAssets = null,
  }) {
    return _then(
      Exercise(
        id: null == id
        ...
        difficulty: null == difficulty
            ...
            : difficulty // ignore: cast_nullable_to_non_nullable
                  as DifficultyLevel,
        safetyReviewStatus: null == safetyReviewStatus
            ? _self.safetyReviewStatus
            : safetyReviewStatus // ignore: cast_nullable_to_non_nullable
                  as SafetyReviewStatus,
        translations: null == translations
            ? _self.translations
            : translations // ignore: cast_nullable_to_non_nullable
                  as Map<String, LocalizedExerciseContent>,
        classification: null == classification
            ? _self.classification
            : classification // ignore: cast_nullable_to_non_nullable
                  as ExerciseClassification,
        providerMappings: null == providerMappings
            ? _self.providerMappings
            : providerMappings // ignore: cast_nullable_to_non_nullable
                  as List<ProviderExerciseMapping>,
        mediaAssets: null == mediaAssets
            ? _self.mediaAssets
            : mediaAssets // ignore: cast_nullable_to_non_nullable
                  as List<MediaAsset>,
      ),
    );
  }
    ...
    switch (_that) {
      case _Exercise() when $default != null:
        return $default(
          ...
          _that.accessTier,
          _that.difficulty,
          _that.safetyReviewStatus,
          _that.translations,
          _that.classification,
          _that.providerMappings,
          _that.mediaAssets,
        );
      case _:
        return orElse();
...
class _Exercise implements Exercise {
  const _Exercise({
    ...
    required this.safetyReviewStatus,
    required Map<String, LocalizedExerciseContent> translations,
    required this.classification,
    List<ProviderExerciseMapping> providerMappings =
        const <ProviderExerciseMapping>[],
    List<MediaAsset> mediaAssets = const <MediaAsset>[],
  }) : _translations = translations,
       _providerMappings = providerMappings,
  ...
  @override
  final SafetyReviewStatus safetyReviewStatus;
  ...
  @JsonKey()
  List<ProviderExerciseMapping> get providerMappings {
    if (_providerMappings is EqualUnmodifiableListView)
      return _providerMappings;
    // ignore: implicit_dynamic_type
  ...
  int get hashCode => Object.hash(
    ...
    classification,
    const DeepCollectionEquality().hash(_providerMappings),
    const DeepCollectionEquality().hash(_mediaAssets),
  );
...
mixin _$LocalizedExerciseContent {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $LocalizedExerciseContentCopyWith<LocalizedExerciseContent> get copyWith =>
      _$LocalizedExerciseContentCopyWithImpl<LocalizedExerciseContent>(
        this as LocalizedExerciseContent,
        _$identity,
      );
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is LocalizedExerciseContent &&
...
abstract mixin class $LocalizedExerciseContentCopyWith<$Res> {
  factory $LocalizedExerciseContentCopyWith(
    LocalizedExerciseContent value,
    $Res Function(LocalizedExerciseContent) _then,
  ) = _$LocalizedExerciseContentCopyWithImpl;
  @useResult
  $Res call({String name, String? description, String? shortCue});
}
...
extension LocalizedExerciseContentPatterns on LocalizedExerciseContent {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_LocalizedExerciseContent value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String name, String? description, String? shortCue)?
    $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _LocalizedExerciseContent() when $default != null:
        return $default(_that.name, _that.description, _that.shortCue);
      case _:
        return orElse();
    }
  }
...
class _LocalizedExerciseContent implements LocalizedExerciseContent {
  const _LocalizedExerciseContent({
    required this.name,
    this.description,
    this.shortCue,
  });
  factory _LocalizedExerciseContent.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$LocalizedExerciseContentCopyWith<_LocalizedExerciseContent> get copyWith =>
      __$LocalizedExerciseContentCopyWithImpl<_LocalizedExerciseContent>(
        this,
        _$identity,
      );
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _LocalizedExerciseContent &&
            (identical(other.name, name) || other.name == name) &&
            (identical(other.description, description) ||
                other.description == description) &&
            (identical(other.shortCue, shortCue) ||
...
/// @nodoc
abstract mixin class _$LocalizedExerciseContentCopyWith<$Res>
    implements $LocalizedExerciseContentCopyWith<$Res> {
  factory _$LocalizedExerciseContentCopyWith(
    _LocalizedExerciseContent value,
    $Res Function(_LocalizedExerciseContent) _then,
  ) = __$LocalizedExerciseContentCopyWithImpl;
  @override
  @useResult
  $Res call({String name, String? description, String? shortCue});
}
...
mixin _$ExerciseClassification {
  ...
  $ExerciseClassificationCopyWith<ExerciseClassification> get copyWith =>
      _$ExerciseClassificationCopyWithImpl<ExerciseClassification>(
        this as ExerciseClassification,
        _$identity,
      );
  ...
  int get hashCode => Object.hash(
    ...
    const DeepCollectionEquality().hash(contexts),
  );
...
abstract mixin class $ExerciseClassificationCopyWith<$Res> {
  factory $ExerciseClassificationCopyWith(
    ExerciseClassification value,
...
abstract mixin class _$ExerciseClassificationCopyWith<$Res>
    implements $ExerciseClassificationCopyWith<$Res> {
  factory _$ExerciseClassificationCopyWith(
    _ExerciseClassification value,
...
mixin _$ProviderExerciseMapping {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ProviderExerciseMappingCopyWith<ProviderExerciseMapping> get copyWith =>
      _$ProviderExerciseMappingCopyWithImpl<ProviderExerciseMapping>(
        this as ProviderExerciseMapping,
        _$identity,
      );
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ProviderExerciseMapping &&
...
abstract mixin class $ProviderExerciseMappingCopyWith<$Res> {
  factory $ProviderExerciseMappingCopyWith(
    ProviderExerciseMapping value,
    $Res Function(ProviderExerciseMapping) _then,
  ) = _$ProviderExerciseMappingCopyWithImpl;
  @useResult
  $Res call({String providerKey, String sourceExerciseId});
}
...
class _$ProviderExerciseMappingCopyWithImpl<$Res>
  ...
  @pragma('vm:prefer-inline')
  @override
  $Res call({Object? providerKey = null, Object? sourceExerciseId = null}) {
    return _then(
...
extension ProviderExerciseMappingPatterns on ProviderExerciseMapping {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ProviderExerciseMapping value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String providerKey, String sourceExerciseId)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ProviderExerciseMapping() when $default != null:
        return $default(_that.providerKey, _that.sourceExerciseId);
      case _:
        return orElse();
    }
  }
...
class _ProviderExerciseMapping implements ProviderExerciseMapping {
  const _ProviderExerciseMapping({
    required this.providerKey,
    required this.sourceExerciseId,
  });
  factory _ProviderExerciseMapping.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ProviderExerciseMappingCopyWith<_ProviderExerciseMapping> get copyWith =>
      __$ProviderExerciseMappingCopyWithImpl<_ProviderExerciseMapping>(
        this,
        _$identity,
      );
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ProviderExerciseMapping &&
            (identical(other.providerKey, providerKey) ||
                other.providerKey == providerKey) &&
            (identical(other.sourceExerciseId, sourceExerciseId) ||
                other.sourceExerciseId == sourceExerciseId));
...
/// @nodoc
abstract mixin class _$ProviderExerciseMappingCopyWith<$Res>
    implements $ProviderExerciseMappingCopyWith<$Res> {
  factory _$ProviderExerciseMappingCopyWith(
    _ProviderExerciseMapping value,
    $Res Function(_ProviderExerciseMapping) _then,
  ) = __$ProviderExerciseMappingCopyWithImpl;
  @override
  @useResult
  $Res call({String providerKey, String sourceExerciseId});
}
...
mixin _$MediaAsset {
  ...
  $MediaAssetCopyWith<MediaAsset> get copyWith =>
      _$MediaAssetCopyWithImpl<MediaAsset>(this as MediaAsset, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.deliveryFileName, deliveryFileName) ||
...
abstract mixin class $MediaAssetCopyWith<$Res> {
  factory $MediaAssetCopyWith(
    MediaAsset value,
    $Res Function(MediaAsset) _then,
  ) = _$MediaAssetCopyWithImpl;
  @useResult
  $Res call({
    String id,
    String exerciseId,
...
/// @nodoc
class _$MediaAssetCopyWithImpl<$Res> implements $MediaAssetCopyWith<$Res> {
      ...
      MediaAsset(
        ...
        mimeType: null == mimeType
            ...
            : mimeType // ignore: cast_nullable_to_non_nullable
                  as String,
        deliveryFileName: null == deliveryFileName
            ? _self.deliveryFileName
            : deliveryFileName // ignore: cast_nullable_to_non_nullable
                  as String,
        checksumSha256: null == checksumSha256
            ? _self.checksumSha256
        ...
        providerKey: freezed == providerKey
            ...
            : providerKey // ignore: cast_nullable_to_non_nullable
                  as String?,
        sourceExerciseId: freezed == sourceExerciseId
            ? _self.sourceExerciseId
            : sourceExerciseId // ignore: cast_nullable_to_non_nullable
                  as String?,
        sourceFileName: freezed == sourceFileName
            ? _self.sourceFileName
...
extension MediaAssetPatterns on MediaAsset {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_MediaAsset value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
    ...
    switch (_that) {
      case _MediaAsset() when $default != null:
        return $default(
          ...
          _that.type,
          _that.mimeType,
          _that.deliveryFileName,
          _that.checksumSha256,
          _that.status,
          _that.isPreferred,
          _that.providerKey,
          _that.sourceExerciseId,
          _that.sourceFileName,
          _that.variant,
          _that.width,
          _that.height,
          _that.durationMs,
...
class _MediaAsset implements MediaAsset {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$MediaAssetCopyWith<_MediaAsset> get copyWith =>
      __$MediaAssetCopyWithImpl<_MediaAsset>(this, _$identity);
...
/// @nodoc
abstract mixin class _$MediaAssetCopyWith<$Res>
    implements $MediaAssetCopyWith<$Res> {
  factory _$MediaAssetCopyWith(
    _MediaAsset value,
    $Res Function(_MediaAsset) _then,
  ) = __$MediaAssetCopyWithImpl;
  @override
  @useResult
  $Res call({
    String id,
...
/// @nodoc
class __$MediaAssetCopyWithImpl<$Res> implements _$MediaAssetCopyWith<$Res> {
...
mixin _$Routine {
  ...
  int get version;
  Map<String, LocalizedRoutineContent> get translations;
  RoutineClassification get classification;
...
abstract mixin class $RoutineCopyWith<$Res> {
  ...
  $Res call({
    ...
    int version,
    Map<String, LocalizedRoutineContent> translations,
    ...
    return _then(
      Routine(
        ...
        translations: null == translations
            ? _self.translations
            : translations // ignore: cast_nullable_to_non_nullable
                  as Map<String, LocalizedRoutineContent>,
        classification: null == classification
            ? _self.classification
            : classification // ignore: cast_nullable_to_non_nullable
                  as RoutineClassification,
        steps: null == steps
            ? _self.steps
...
extension RoutinePatterns on Routine {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_Routine value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _Routine implements Routine {
  ...
  @override
  final RoutineClassification classification;
...
mixin _$LocalizedRoutineContent {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $LocalizedRoutineContentCopyWith<LocalizedRoutineContent> get copyWith =>
      _$LocalizedRoutineContentCopyWithImpl<LocalizedRoutineContent>(
        this as LocalizedRoutineContent,
        _$identity,
      );
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is LocalizedRoutineContent &&
            (identical(other.name, name) || other.name == name) &&
...
abstract mixin class $LocalizedRoutineContentCopyWith<$Res> {
  factory $LocalizedRoutineContentCopyWith(
    LocalizedRoutineContent value,
    $Res Function(LocalizedRoutineContent) _then,
  ) = _$LocalizedRoutineContentCopyWithImpl;
  @useResult
...
extension LocalizedRoutineContentPatterns on LocalizedRoutineContent {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_LocalizedRoutineContent value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String name, String summary)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _LocalizedRoutineContent() when $default != null:
        return $default(_that.name, _that.summary);
      case _:
        return orElse();
    }
  }
...
class _LocalizedRoutineContent implements LocalizedRoutineContent {
  ...
  factory _LocalizedRoutineContent.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$LocalizedRoutineContentCopyWith<_LocalizedRoutineContent> get copyWith =>
      __$LocalizedRoutineContentCopyWithImpl<_LocalizedRoutineContent>(
        this,
        _$identity,
      );
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _LocalizedRoutineContent &&
            (identical(other.name, name) || other.name == name) &&
            (identical(other.summary, summary) || other.summary == summary));
  }
...
/// @nodoc
abstract mixin class _$LocalizedRoutineContentCopyWith<$Res>
    implements $LocalizedRoutineContentCopyWith<$Res> {
  factory _$LocalizedRoutineContentCopyWith(
    _LocalizedRoutineContent value,
    $Res Function(_LocalizedRoutineContent) _then,
  ) = __$LocalizedRoutineContentCopyWithImpl;
  @override
  @useResult
  $Res call({String name, String summary});
}
...
mixin _$RoutineClassification {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $RoutineClassificationCopyWith<RoutineClassification> get copyWith =>
      _$RoutineClassificationCopyWithImpl<RoutineClassification>(
        this as RoutineClassification,
        _$identity,
      );
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is RoutineClassification &&
            const DeepCollectionEquality().equals(other.bodyAreas, bodyAreas) &&
            const DeepCollectionEquality().equals(other.goals, goals) &&
            const DeepCollectionEquality().equals(other.positions, positions) &&
            const DeepCollectionEquality().equals(other.equipment, equipment) &&
...
abstract mixin class $RoutineClassificationCopyWith<$Res> {
  factory $RoutineClassificationCopyWith(
    RoutineClassification value,
    $Res Function(RoutineClassification) _then,
  ) = _$RoutineClassificationCopyWithImpl;
  @useResult
  $Res call({
    Set<String> bodyAreas,
    Set<String> goals,
...
extension RoutineClassificationPatterns on RoutineClassification {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_RoutineClassification value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _RoutineClassification implements RoutineClassification {
  const _RoutineClassification({
    required Set<String> bodyAreas,
    required Set<String> goals,
    required Set<String> positions,
    Set<String> equipment = const <String>{},
    Set<String> contexts = const <String>{},
  }) : _bodyAreas = bodyAreas,
       _goals = goals,
       _positions = positions,
       _equipment = equipment,
       _contexts = contexts;
  factory _RoutineClassification.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$RoutineClassificationCopyWith<_RoutineClassification> get copyWith =>
      __$RoutineClassificationCopyWithImpl<_RoutineClassification>(
        this,
        _$identity,
      );
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _RoutineClassification &&
            const DeepCollectionEquality().equals(
              other._bodyAreas,
              _bodyAreas,
            ) &&
...
/// @nodoc
abstract mixin class _$RoutineClassificationCopyWith<$Res>
    implements $RoutineClassificationCopyWith<$Res> {
  factory _$RoutineClassificationCopyWith(
    _RoutineClassification value,
    $Res Function(_RoutineClassification) _then,
  ) = __$RoutineClassificationCopyWithImpl;
  @override
  @useResult
  $Res call({
    Set<String> bodyAreas,
...
mixin _$RoutineStep {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $RoutineStepCopyWith<RoutineStep> get copyWith =>
      _$RoutineStepCopyWithImpl<RoutineStep>(this as RoutineStep, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.restAfterSeconds, restAfterSeconds) ||
                other.restAfterSeconds == restAfterSeconds) &&
...
abstract mixin class $RoutineStepCopyWith<$Res> {
  factory $RoutineStepCopyWith(
    RoutineStep value,
    $Res Function(RoutineStep) _then,
  ) = _$RoutineStepCopyWithImpl;
  @useResult
  $Res call({
    String id,
    String exerciseId,
...
/// @nodoc
class _$RoutineStepCopyWithImpl<$Res> implements $RoutineStepCopyWith<$Res> {
...
extension RoutineStepPatterns on RoutineStep {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_RoutineStep value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
    ...
    switch (_that) {
      case _RoutineStep() when $default != null:
        return $default(
          ...
          _that.repetitionCount,
          _that.restAfterSeconds,
          _that.isOptional,
          _that.sideMode,
        );
      case _:
...
class _RoutineStep implements RoutineStep {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$RoutineStepCopyWith<_RoutineStep> get copyWith =>
      __$RoutineStepCopyWithImpl<_RoutineStep>(this, _$identity);
...
/// @nodoc
abstract mixin class _$RoutineStepCopyWith<$Res>
    implements $RoutineStepCopyWith<$Res> {
  factory _$RoutineStepCopyWith(
    _RoutineStep value,
    $Res Function(_RoutineStep) _then,
  ) = __$RoutineStepCopyWithImpl;
  @override
  @useResult
  $Res call({
    String id,
...
/// @nodoc
class __$RoutineStepCopyWithImpl<$Res> implements _$RoutineStepCopyWith<$Res> {
