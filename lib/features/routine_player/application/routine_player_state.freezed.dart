...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( RoutinePlayerLoading value)?  loading,TResult Function( RoutinePlayerFailed value)?  failed,TResult Function( RoutinePlayerReady value)?  ready,TResult Function( RoutinePlayerConflict value)?  conflict,TResult Function( RoutinePlayerSaveError value)?  saveError,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
return ready(_that);case RoutinePlayerConflict() when conflict != null:
return conflict(_that);case RoutinePlayerSaveError() when saveError != null:
return saveError(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( RoutinePlayerLoading value)  loading,required TResult Function( RoutinePlayerFailed value)  failed,required TResult Function( RoutinePlayerReady value)  ready,required TResult Function( RoutinePlayerConflict value)  conflict,required TResult Function( RoutinePlayerSaveError value)  saveError,}){
final _that = this;
switch (_that) {
case RoutinePlayerLoading():
return loading(_that);case RoutinePlayerFailed():
return failed(_that);case RoutinePlayerReady():
return ready(_that);case RoutinePlayerConflict():
return conflict(_that);case RoutinePlayerSaveError():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( RoutinePlayerLoading value)?  loading,TResult? Function( RoutinePlayerFailed value)?  failed,TResult? Function( RoutinePlayerReady value)?  ready,TResult? Function( RoutinePlayerConflict value)?  conflict,TResult? Function( RoutinePlayerSaveError value)?  saveError,}){
final _that = this;
switch (_that) {
case RoutinePlayerLoading() when loading != null:
return loading(_that);case RoutinePlayerFailed() when failed != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  loading,TResult Function()?  failed,TResult Function( RoutinePlaybackSession session)?  ready,TResult Function( RoutineSessionSnapshot resumable)?  conflict,TResult Function()?  saveError,required TResult orElse(),}) {final _that = this;
switch (_that) {
case RoutinePlayerLoading() when loading != null:
return loading();case RoutinePlayerFailed() when failed != null:
return failed();case RoutinePlayerReady() when ready != null:
return ready(_that.session);case RoutinePlayerConflict() when conflict != null:
return conflict(_that.resumable);case RoutinePlayerSaveError() when saveError != null:
return saveError();case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  loading,required TResult Function()  failed,required TResult Function( RoutinePlaybackSession session)  ready,required TResult Function( RoutineSessionSnapshot resumable)  conflict,required TResult Function()  saveError,}) {final _that = this;
switch (_that) {
case RoutinePlayerLoading():
return loading();case RoutinePlayerFailed():
return failed();case RoutinePlayerReady():
return ready(_that.session);case RoutinePlayerConflict():
return conflict(_that.resumable);case RoutinePlayerSaveError():
return saveError();}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  loading,TResult? Function()?  failed,TResult? Function( RoutinePlaybackSession session)?  ready,TResult? Function( RoutineSessionSnapshot resumable)?  conflict,TResult? Function()?  saveError,}) {final _that = this;
switch (_that) {
case RoutinePlayerLoading() when loading != null:
return loading();case RoutinePlayerFailed() when failed != null:
return failed();case RoutinePlayerReady() when ready != null:
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$RoutinePlayerConflictCopyWith<RoutinePlayerConflict> get copyWith => _$RoutinePlayerConflictCopyWithImpl<RoutinePlayerConflict>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RoutinePlayerConflict&&(identical(other.resumable, resumable) || other.resumable == resumable));
}
...
/// @nodoc
abstract mixin class $RoutinePlayerConflictCopyWith<$Res> implements $RoutinePlayerStateCopyWith<$Res> {
  factory $RoutinePlayerConflictCopyWith(RoutinePlayerConflict value, $Res Function(RoutinePlayerConflict) _then) = _$RoutinePlayerConflictCopyWithImpl;
@useResult
$Res call({
 RoutineSessionSnapshot resumable
});
...
/// Create a copy of RoutinePlayerState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? resumable = null,}) {
  return _then(RoutinePlayerConflict(
resumable: null == resumable ? _self.resumable : resumable // ignore: cast_nullable_to_non_nullable
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RoutinePlayerSaveError);
}
