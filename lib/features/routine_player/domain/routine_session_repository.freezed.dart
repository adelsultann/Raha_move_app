...
mixin _$RoutineStepSnapshot {
  ...
  bool get skipRequested;

  /// Create a copy of RoutineStepSnapshot
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $RoutineStepSnapshotCopyWith<RoutineStepSnapshot> get copyWith =>
      _$RoutineStepSnapshotCopyWithImpl<RoutineStepSnapshot>(
        this as RoutineStepSnapshot,
        _$identity,
      );
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.activeDurationSeconds, activeDurationSeconds) ||
                other.activeDurationSeconds == activeDurationSeconds) &&
            (identical(other.skipRequested, skipRequested) ||
...
abstract mixin class $RoutineStepSnapshotCopyWith<$Res> {
  factory $RoutineStepSnapshotCopyWith(
    RoutineStepSnapshot value,
    $Res Function(RoutineStepSnapshot) _then,
  ) = _$RoutineStepSnapshotCopyWithImpl;
  @useResult
  $Res call({
    String stepId,
    String exerciseId,
...
class _$RoutineStepSnapshotCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object? activeDurationSeconds = null,
    Object? skipRequested = null,
  }) {
    return _then(
      RoutineStepSnapshot(
        stepId: null == stepId
        ...
        activeDurationSeconds: null == activeDurationSeconds
            ? _self.activeDurationSeconds
            : activeDurationSeconds // ignore: cast_nullable_to_non_nullable
                  as int,
        skipRequested: null == skipRequested
            ? _self.skipRequested
            : skipRequested // ignore: cast_nullable_to_non_nullable
                  as bool,
      ),
    );
  }
...
extension RoutineStepSnapshotPatterns on RoutineStepSnapshot {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_RoutineStepSnapshot value)? $default, {
...
class _RoutineStepSnapshot implements RoutineStepSnapshot {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$RoutineStepSnapshotCopyWith<_RoutineStepSnapshot> get copyWith =>
      __$RoutineStepSnapshotCopyWithImpl<_RoutineStepSnapshot>(
        this,
        _$identity,
      );
...
/// @nodoc
abstract mixin class _$RoutineStepSnapshotCopyWith<$Res>
    implements $RoutineStepSnapshotCopyWith<$Res> {
  factory _$RoutineStepSnapshotCopyWith(
    _RoutineStepSnapshot value,
    $Res Function(_RoutineStepSnapshot) _then,
  ) = __$RoutineStepSnapshotCopyWithImpl;
  @override
  @useResult
  $Res call({
    String stepId,
...
mixin _$RoutineSessionSnapshot {
  ...
  int? get currentStepActiveSeconds;
  List<RoutineStepSnapshot> get steps;

  /// Create a copy of RoutineSessionSnapshot
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $RoutineSessionSnapshotCopyWith<RoutineSessionSnapshot> get copyWith =>
      _$RoutineSessionSnapshotCopyWithImpl<RoutineSessionSnapshot>(
        this as RoutineSessionSnapshot,
        _$identity,
      );
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is RoutineSessionSnapshot &&
            ...
            (identical(other.status, status) || other.status == status) &&
            (identical(other.currentStepPosition, currentStepPosition) ||
                other.currentStepPosition == currentStepPosition) &&
            (identical(
                  other.currentStepActiveSeconds,
...
abstract mixin class $RoutineSessionSnapshotCopyWith<$Res> {
  factory $RoutineSessionSnapshotCopyWith(
    RoutineSessionSnapshot value,
    $Res Function(RoutineSessionSnapshot) _then,
  ) = _$RoutineSessionSnapshotCopyWithImpl;
  @useResult
  $Res call({
    String sessionId,
    String routineId,
    ...
    List<RoutineStepSnapshot> steps,
  });
}
...
class _$RoutineSessionSnapshotCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object? currentStepActiveSeconds = freezed,
    Object? steps = null,
  }) {
    return _then(
      RoutineSessionSnapshot(
        ...
        status: null == status
            ...
            : status // ignore: cast_nullable_to_non_nullable
                  as String,
        currentStepPosition: freezed == currentStepPosition
            ? _self.currentStepPosition
            : currentStepPosition // ignore: cast_nullable_to_non_nullable
                  as int?,
        currentStepActiveSeconds: freezed == currentStepActiveSeconds
            ? _self.currentStepActiveSeconds
            : currentStepActiveSeconds // ignore: cast_nullable_to_non_nullable
                  as int?,
        steps: null == steps
            ? _self.steps
...
extension RoutineSessionSnapshotPatterns on RoutineSessionSnapshot {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_RoutineSessionSnapshot value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
    ...
    switch (_that) {
      case _RoutineSessionSnapshot() when $default != null:
        return $default(
          ...
          _that.currentStepActiveSeconds,
          _that.steps,
        );
      case _:
        return orElse();
...
class _RoutineSessionSnapshot implements RoutineSessionSnapshot {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$RoutineSessionSnapshotCopyWith<_RoutineSessionSnapshot> get copyWith =>
      __$RoutineSessionSnapshotCopyWithImpl<_RoutineSessionSnapshot>(
        this,
        _$identity,
      );
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _RoutineSessionSnapshot &&
            (identical(other.sessionId, sessionId) ||
                other.sessionId == sessionId) &&
            (identical(other.routineId, routineId) ||
                other.routineId == routineId) &&
...
/// @nodoc
abstract mixin class _$RoutineSessionSnapshotCopyWith<$Res>
    implements $RoutineSessionSnapshotCopyWith<$Res> {
  factory _$RoutineSessionSnapshotCopyWith(
    _RoutineSessionSnapshot value,
    $Res Function(_RoutineSessionSnapshot) _then,
  ) = __$RoutineSessionSnapshotCopyWithImpl;
  @override
  @useResult
  $Res call({
    String sessionId,
