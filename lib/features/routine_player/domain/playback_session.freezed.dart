...
mixin _$RoutineStepPlayback {
  ...
  $RoutineStepPlaybackCopyWith<RoutineStepPlayback> get copyWith =>
      _$RoutineStepPlaybackCopyWithImpl<RoutineStepPlayback>(
        this as RoutineStepPlayback,
        _$identity,
      );
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.creditedSeconds, creditedSeconds) ||
                other.creditedSeconds == creditedSeconds) &&
...
abstract mixin class $RoutineStepPlaybackCopyWith<$Res> {
  factory $RoutineStepPlaybackCopyWith(
    RoutineStepPlayback value,
    $Res Function(RoutineStepPlayback) _then,
  ) = _$RoutineStepPlaybackCopyWithImpl;
  @useResult
  $Res call({
    String stepId,
    String exerciseId,
      ...
      RoutineStepPlayback(
        ...
        state: null == state
            ...
            : state // ignore: cast_nullable_to_non_nullable
                  as StepPlaybackState,
        creditedSeconds: null == creditedSeconds
            ? _self.creditedSeconds
            : creditedSeconds // ignore: cast_nullable_to_non_nullable
                  as int,
...
extension RoutineStepPlaybackPatterns on RoutineStepPlayback {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_RoutineStepPlayback value)? $default, {
...
class _RoutineStepPlayback implements RoutineStepPlayback {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$RoutineStepPlaybackCopyWith<_RoutineStepPlayback> get copyWith =>
      __$RoutineStepPlaybackCopyWithImpl<_RoutineStepPlayback>(
        this,
        _$identity,
      );
...
/// @nodoc
abstract mixin class _$RoutineStepPlaybackCopyWith<$Res>
    implements $RoutineStepPlaybackCopyWith<$Res> {
  factory _$RoutineStepPlaybackCopyWith(
    _RoutineStepPlayback value,
    $Res Function(_RoutineStepPlayback) _then,
  ) = __$RoutineStepPlaybackCopyWithImpl;
  @override
  @useResult
  $Res call({
    String stepId,
...
mixin _$RoutinePlaybackSession {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $RoutinePlaybackSessionCopyWith<RoutinePlaybackSession> get copyWith =>
      _$RoutinePlaybackSessionCopyWithImpl<RoutinePlaybackSession>(
        this as RoutinePlaybackSession,
        _$identity,
      );
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is RoutinePlaybackSession &&
...
abstract mixin class $RoutinePlaybackSessionCopyWith<$Res> {
  factory $RoutinePlaybackSessionCopyWith(
    RoutinePlaybackSession value,
    $Res Function(RoutinePlaybackSession) _then,
  ) = _$RoutinePlaybackSessionCopyWithImpl;
  @useResult
  $Res call({
    String sessionId,
    String routineId,
...
extension RoutinePlaybackSessionPatterns on RoutinePlaybackSession {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_RoutinePlaybackSession value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _RoutinePlaybackSession extends RoutinePlaybackSession {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$RoutinePlaybackSessionCopyWith<_RoutinePlaybackSession> get copyWith =>
      __$RoutinePlaybackSessionCopyWithImpl<_RoutinePlaybackSession>(
        this,
        _$identity,
      );
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _RoutinePlaybackSession &&
            (identical(other.sessionId, sessionId) ||
                other.sessionId == sessionId) &&
            (identical(other.routineId, routineId) ||
                other.routineId == routineId) &&
...
/// @nodoc
abstract mixin class _$RoutinePlaybackSessionCopyWith<$Res>
    implements $RoutinePlaybackSessionCopyWith<$Res> {
  factory _$RoutinePlaybackSessionCopyWith(
    _RoutinePlaybackSession value,
    $Res Function(_RoutinePlaybackSession) _then,
  ) = __$RoutinePlaybackSessionCopyWithImpl;
  @override
  @useResult
  $Res call({
    String sessionId,
